...
from llmshearing.datasets.streaming_dataset import (
    TextDynamicStreamingDataset,
    TextStreamingDataset,
)
...
def build_text_dataloader(
    ...
    if dynamic:
        dataset = TextDynamicStreamingDataset(
    ...
    print(f"prefetch_factor before: {prefetch_factor}")
    prefetch_factor = (
        None if cfg.get("prefetch_factor") == "None" else cfg.get("prefetch_factor")
    )
    print(f"prefetch_factor after: {prefetch_factor}")
